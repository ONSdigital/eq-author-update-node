...
import WarningIcon from "components/components-original/OfflineBanner/icon-warning.svg?inline";
...
const LockedBanner = ({ questionnaire }) => {
  const { trigger, component: UnlockModal } =
    useQuestionnaireLockingModal(questionnaire);
